...
function _searchGroup(path, group, _options){

  var group = fileGroupStrategy();
  
  _search(path, group, {strategy:group  }  )
...
function _search(path, name, _options) {
    ...
    var predicate = options.predicate || default_predicate;
